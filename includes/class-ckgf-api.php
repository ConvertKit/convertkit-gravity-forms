...
class CKGF_API {
	...
	public function get_landing_page_html( $url ) {
		...
		$script .= "<script type='text/javascript' src='" . CKGF_PLUGIN_VERSION . 'resources/frontend/js/convertkit.js?ver=' . CKGF_PLUGIN_VERSION . "'></script>"; // phpcs:ignore
	...
	private function get_user_agent() {
		...
		return sprintf(
			'WordPress/%1$s;PHP/%2$s;ConvertKitGravityForms/%3$s;%4$s',
			$wp_version,
			phpversion(),
			CKGF_PLUGIN_VERSION,
			home_url( '/' )
